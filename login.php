...
<body>
   ...
   <div class="container"><!-- container begin -->
       <form action="" class="form-login" method="post"><!-- form-login begin -->
           ...
           <input type="text" class="form-control" placeholder="E-Mail" name="admin_email" required>
           
           <input type="password" class="form-control" placeholder="Passwort" name="admin_pass" required>
