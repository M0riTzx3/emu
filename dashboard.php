...
<div class="row"><!-- row no: 1 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <h1 class="page-header"> Verwaltung </h1>
        
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li class="active"><!-- active begin -->
            
                <i class="fa fa-dashboard"></i> Verwaltung
        ...
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Neue Bestellungen
            ...
            <div class="panel-body"><!-- panel-body begin -->
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        if($order_status=='pending'){
                                            ...
                                            echo $order_status='Wartend';
                                            
                                        }else{
                                            
                                            echo $order_status='Abgeschlossen';
                ...
                <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="index.php?view_orders"><!-- a href begin -->
                        ...
                        Alle Bestellungen anzeigen <i class="fa fa-arrow-circle-right"></i>
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        ...
                        <i class="fa fa-envelope"></i> <span> Nummer </span> <?php echo $admin_contact; ?> <br/>
                    </div><!-- widget-content-expanded finish -->
                    
                    <hr class="dotted short">
                    
                    <h5 class="text-muted"> Über </h5>
